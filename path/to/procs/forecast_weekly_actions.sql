create procedure "Decisioning_Procs"."Forecast_Weekly_Actions"( 
  in "Counter" integer,
...
begin
  ...
  update "Forecast_Loop_Table" as "flt"
    ...
    join "CITeam"."CusCan_Segment_Lookup" as "csl"
  ...
  select "base"."Subs_Week_And_Year",
    ...
    from #Segment_Sizes as "base"
      ...
      and "Latest_Load" = 1
      left outer join "CITeam"."TOBEDROPPED_05_11_2019segment_id_lookup" as "SL"
...
*/
  -- Merge from OC table
  set "Dynamic_SQL"
     = ' set  P_target00  = b.P_target00 '
     || ' ,P_target01      = b.P_target01  '
     || ' ,P_target10 = b.P_target10  '
     || ' ,P_target11 = b.P_target11  ';
  -- TA
  execute immediate
    'update Forecast_Loop_Table as a '
     || "Dynamic_SQL"
  ...
  update "Forecast_Loop_Table"
    set "OC_model_out" = (case when "rand_OC_model" > 0 and "rand_OC_model" <= "P_target00" then '00'
    when "rand_OC_model" > "P_target00" and "rand_OC_model" <= ("P_target00"+"P_target01") then '01'
    when "rand_OC_model" > ("P_target00"+"P_target01") and "rand_OC_model" <= ("P_target00"+"P_target01"+"P_target10") then '10'
    when "rand_OC_model" > ("P_target00"+"P_target01"+"P_target10") and "rand_OC_model" <= 1 then '11' end)
    where "DTV_Active" = 1;
  update "Forecast_Loop_Table"
    set "Offers_Applied_Next_7D_DTV" = case when "OC_model_out" in( '10','11' ) then 1 else 0 end;
  update "Forecast_Loop_Table"
    set "DTV_Contracts_Applied_In_Next_7D" = case when "OC_model_out" in( '01','11' ) then 1 else 0 end;
  --------------------------------------------------------------------------------------------------------------
  -- Pending Cancels -------------------------------------------------------------------------------------------
  --------------------------------------------------------------------------------------------------------------
  --- pred DTV_PC ----
  ...
  update "Forecast_Loop_Table" as "a"
    ...
    *case when "Include_Offer_Bridging" = 'Yes' then 1 else 0 end,0) from
    ...
    join "gma80"."Offer_Bridging_EOO_Treatment_Rates_0410" as "EOO"
...
end //grant execute on Decisioning_Procs.Forecast_Insert_New_Custs_Into_Loop_Table to decisioning;
//sp_helptext 'Decisioning_Procs.Forecast_Insert_New_Custs_Into_Loop_Table';
//grant execute on Decisioning_Procs.DTV_PV_TP_PC_Conversion to aal87;
//grant execute on Decisioning_Procs.Create_Seasonality_Estimates to aal87;
//Grant execute on Decisioning_Procs.Forecast_TA_Vol_Dist to aal87;
//Grant execute on Decisioning_Procs.Intraweek_PCs_Dist to aal87;
//Grant execute on Decisioning_Procs.Intraweek_ABs_Dist to aal87;
//Grant execute on Decisioning_Procs.PC_Status_Movement_Probabilities to aal87;
//Grant execute on Decisioning_Procs.AB_Status_Movement_Probabilities to aal87;
//Grant execute on Decisioning_Procs.Forecast_CusCan_Rates to aal87;
//Grant execute on Decisioning_Procs.Forecast_SysCan_Rates to aal87;
//Grant execute on Decisioning_Procs.Forecast_Activation_Vols to aal87;
//Grant execute on Decisioning_Procs.Build_Forecast_New_Cust_Sample to aal87;
//Grant execute on Decisioning_Procs.Forecast_Insert_New_Custs_Into_Loop_Table to aal87;
//Grant execute on Decisioning_Procs.Create_Seasonality_Estimates to aal87;
//Grant execute on Decisioning_Procs.CusCan_Rates_Voice_To_LiveChat_Ratio to aal87;
//Grant execute on Decisioning_Procs.Forecast_Value_Vol_Dist to aal87;
//Grant execute on Decisioning_Procs.Forecast_WC_Vol_Dist to aal87;
//Grant execute on Decisioning_Procs.Forecast_PC_Conversion_Rates to aal87;
//Grant execute on Decisioning_Procs.PC_Duration_Dist to aal87;
//Grant execute on Decisioning_Procs.BB_Regrade_Rates to aal87;
//Grant execute on Decisioning_Procs.Add_Transformed_Variables_For_Segments  to aal87;
//Grant execute on Decisioning_Procs.Offer_Applied_Sample to aal87;
//Grant execute on Decisioning_Procs.DTV_PV_TP_PC_Conversion to aal87;
//Grant execute on Decisioning_Procs.Forecast_Insert_New_Custs_Into_Loop_Table to aal87;
//Grant execute on Decisioning_Procs.Forecast_Update_Forecast_Loop_Table_For_Nxt_Wk to aal87;
//select max(subs_week_and_year) from sasdecb.fcast_sim_output;
//select *
//from dbo.TableSizes
//where tableowner = 'gma80' 
//order by UpdateDate desc;
//sp_helptext 'Decisioning_Procs.Forecast_Weekly_Actions'
//select top 10 * from segment_id_lookup;
//sp_helptext 'Decisioning_Procs.Forecast_Insert_New_Custs_Into_Loop_Table';
//sp_helptext 'Decisioning_Procs.Forecast_Update_Forecast_Loop_Table_For_Nxt_Wk'
